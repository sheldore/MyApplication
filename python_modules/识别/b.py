...
def CatchPICFromVideo(window_name, camera_idx, catch_pic_num, path_name):
    ...
    classfier = cv2.CascadeClassifier("D:\\Program Files\\opencv\\build\\etc\\haarcascades\\haarcascade_frontalface_alt2.xml")
...
if __name__ == '__main__':
    if len(sys.argv) != 1:
        ...
        CatchPICFromVideo("截取人脸", 0, 1000, 'D:\\Users\\sheldon\\Desktop\\Python\\data\\mote1')

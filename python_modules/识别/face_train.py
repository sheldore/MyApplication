...
class Model:
    ...
    MODEL_PATH = './model/liziqiang.face.model.h5'
...
if __name__ == '__main__':
    ...
    dataset = Dataset('D:\\Users\\sheldon\\Desktop\\Python\\data\\liziqiang')
    dataset.load()
...
if __name__ == '__main__':
    # dataset = Dataset('./data/')
    dataset = Dataset('D:\\Users\\sheldon\\Desktop\\Python\\data')
    dataset.load()
